...
<div class="min-h-full bg-white">
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" class="relative flex max-w-xs items-center rounded-sm bg-white text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    <span class="absolute -inset-1.5"></span>
                                    <span class="sr-only">Open user menu</span>
                                    <img class="size-8 rounded-full" src="/user.png" alt="">
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <header class="bg-white pt-16">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-center items-center">
            <h1 class="text-5xl font-light tracking-tight text-black">{{ $heading }}</h1>
        </div>
    </header>
    <main>
